# ENGINEERING GOVERNANCE BASELINE TEMPLATE

This is a template scaffold. Downstream projects should maintain the live document at `docs/engineering/engineering-baseline.md`.
